...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const { userId, password } = e.currentTarget;
  ...
  return (
    <LoginContainer>
      <LoginForm onSubmit={handleSubmit}>
        <InputWrapper>
          <Input type="text" value={loginData.userId} placeholder="아이디"></Input>
          <Input type="password" value={loginData.password} autoComplete="new-password" placeholder="비밀번호"></Input>
        </InputWrapper>
        <Button>로그인</Button>
        <TextButtonsWrapper>
