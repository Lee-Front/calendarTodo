...
const CalendarPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const params = {
        startDate: calendar.searchInfo.startDate,
        endDate: calendar.searchInfo.endDate,
      };
      const calendarTodoInfo: DayTodoInfo[] = await getCalendar(
        calendar.searchInfo
      );
  ...
  const getCalendar = async (searchInfo: SearchInfo) => {
    const response = await axios.get("/calendar", { params: { searchInfo } });
