...
const CalendarPage: React.FC = () => {
  ...
  const createCalendar = (
    ...
    // 이전 월의 마지막 날
    const prevLastDate = new Date(cur.year, cur.month, 1 - firstDay);
    ...
    // 다음 월의 첫 날
    console.log("lastDate: ", lastDate.getMonth() === nextLastDate.getMonth());
    console.log("nextLastDate: ", nextLastDate.getMonth());
