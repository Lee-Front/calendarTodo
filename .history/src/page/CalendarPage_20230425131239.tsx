  ...
  return (
    <CalendarContainer>
      <CalendarMonthWrapper>
        <CalendarMonthButtonWrapper>
          <CalendarMonthButton>◀</CalendarMonthButton>
        </CalendarMonthButtonWrapper>
        4월
        <CalendarMonthButtonWrapper></CalendarMonthButtonWrapper><CalendarMonthButton>▶</CalendarMonthButton></CalendarMonthButtonWrapper>
      </CalendarMonthWrapper>
      <CalendarDayWrapper>
...
const CalendarMonthButtonWrapper = styled.div``;
