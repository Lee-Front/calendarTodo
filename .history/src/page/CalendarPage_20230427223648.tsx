...
const CalendarPage: React.FC = () => {
  ...
  const createCalendar = (
    ...
    searchInfo.startDate = `${prevLastDate.getFullYear()}-${prevLastDate.getMonth()+1}-${prevLastDate.getDate()}`;
    searchInfo.endDate = `${lastDate.getFullYear()}-${lastDate.getMonth()+1}-${lastDate.getDate()}`;
