...
const PostIt = ({ dayInfo, backgroundColor }: PostItProps) => {
  ...
  const [color, setColor] = useState({ r: 255, g: 218, b: 38, a: 1 });
...
const PostFoldedEdge = styled.div<{ backgroundColor: string; r: number; g: number; b: number }>`
  ...
  right: 0;
  bottom: 0;
  border-top: ${(props) => `1.5rem solid rgba(${props.r * 1.07},${props.g * 1.07},${props.b * 1.07},1)`};
  //border-top: 15px solid #ffe36e;
  border-right: 1.5rem solid ${(props) => props.backgroundColor};
`;
