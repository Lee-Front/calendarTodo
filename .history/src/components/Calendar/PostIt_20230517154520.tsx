...
const CalendarDayPost = styled.div<{ color: { r: number; g: number; b: number; a: number } }>`
  position: relative;
  font-size: 2rem;
  flex: 1;
  //background-color: #ffda26;
  background-color: ${(props) => `rgba(${props.color.r},${props.color.g},${props.color.b},${props.color.a})`}
  aspect-ratio: 1;
`;
