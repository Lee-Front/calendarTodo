...
const DayList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const calendarTodoInfo: { [key: string]: TodoInfo } = await getTodoListByCurrentMonth(calendar.calendarInfo);
  ...
  const getTodoListByCurrentMonth = async (searchInfo: DateRange) => {
    const params = {
