    ...
    try {
      ...
      if (userId !== null && password !== null) {
        ...
        getRequest.onsuccess = () => {
          ...
          const accessToken = createJwt(userId, "60s", accessKey);
          const refreshToken = createJwt(userId, "60s", refreshKey);
...
export const handlers = [
  rest.post("/refreshToken", async (req, res, ctx) => {
    ...
    const token = await createJwt(refreshToken, "2h", refreshKey);
  ...
  rest.post("/login", async (req, res, ctx) => {
    ...
    const cookie = serialize("refreshToken", refreshToken, cookieOptions);
