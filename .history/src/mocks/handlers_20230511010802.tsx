import { rest, RestContext, MockedRequest, ResponseComposition, DefaultBodyType } from "msw";
...
export const authInterceptor: RequestHandler<MockedRequest<DefaultBodyType>> = (req, res, ctx) => {
  console.log("req : ", req);
  const accessToken = "";
  // if (accessToken) {
