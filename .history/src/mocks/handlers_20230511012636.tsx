import { MockedRequest, ResponseComposition, rest, RestContext, DefaultRequestBodyType } from "msw";
...
export const authInterceptor = async (req: MockedRequest, res: ResponseComposition, ctx: RestContext) => {
