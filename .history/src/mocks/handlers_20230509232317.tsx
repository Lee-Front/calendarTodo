...
const createJwt = (userId: string): Promise<string> => {
...
const login = (userId: string, password: string): Promise<{ userId: string; token: string }> => {
  return new Promise(async (resolve, reject) => {
    try {
      const db = await openDatabase();
      ...
      if (userId !== null && password !== null) {
        ...
        addRequest.onsuccess = () => {
          ...
          getRequest.onsuccess = () => {
            ...
            resolve({ userId: userData.userId, token: token });
          };
          getRequest.onerror = () => {
            reject();
          };
