...
const JWT_ACCESS_KEY = "calendar-todo-secret-lee-dawn-access-token-1154";
const JWT_REFRESH_KEY = "calendar-todo-secret-lee-dawn-refresh-token-3390";

// 토큰 유효시간을 지정할 변수
const createJwt = async (userId: string, tokenExp: string, key: string): Promise<string> => {
...
const validateToken = async (token: string, key: string) => {
  try {
