...
Cookies.set("refreshToken", "refreshToken", { expires: 1 / 24, secure: true, sameSite: "strict" });
...
const validateToken = async (token: string) => {
  try {
    const jwt = jose.jwtVerify(token, secretKey);
    return true;
    //return jwt["urn:calendarTodo:claim"];
  } catch (e) {
    console.log("e : ", e);
    return false;
  }
