...
const refreshTokenInterceptor = () => async (req: any, res: any, ctx: any) => {
  ...
  //   } catch (error) {
  //     // Failed to refresh the access token, redirect to login page
  //     return res(ctx.status(401));
  //   }
  // }
  // // Set the access token in the Authorization header and proceed with the request
  // return req(
  //   authInterceptor(accessToken)(req, res, ctx)
  // );
};
...
export const handlers = [
  ...
  // 포스트 목록
  rest.get<Todo[]>("/posts", refreshTokenInterceptor(), async (req: any, res: any, ctx: any) => {
